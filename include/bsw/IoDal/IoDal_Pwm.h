...
#define IODAL_PWM_AR_RELEASE_MINOR_VERSION        2
#define IODAL_PWM_AR_RELEASE_REVISION_VERSION     2

#define IODAL_PWM_SW_MAJOR_VERSION                1
#define IODAL_PWM_SW_MINOR_VERSION                0
